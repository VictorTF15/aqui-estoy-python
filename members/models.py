...
class Casos(models.Model):
    ...
    imagen3 = models.TextField(max_length=500, null=True, blank=True)
    imagen4 = models.TextField(max_length=500, null=True, blank=True)
...
class Evidencias(models.Model):
    ...
    imagen1 = models.TextField(null=True, blank=True)
...
class Reportes(models.Model):
    ...
    titulo = models.CharField(max_length=200)
    descripcion = models.TextField()
    evidencia1 = models.TextField(max_length=500, null=True, blank=True)
    evidencia2 = models.TextField(max_length=500, null=True, blank=True)
    evidencia3 = models.TextField(max_length=500, null=True, blank=True)
    fecha_creacion = models.DateTimeField(default=timezone.now)
...
class DocumentosOCR(models.Model):
    ...
    ruta_imagen = models.TextField(max_length=500)
